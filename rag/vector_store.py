...
from utils.file_handler import txt_loader, listdir_with_allowed_type, pdf_loader, get_file_md5_hex
    ...
    def load_document(self):
        ...
        for path in allowed_file_path:
            ...
            if check_md5_hex(md5_hex):
                logger.info(f"[加载知识库]{path}内容已经存入知识库，跳过")
                continue
            try:
...
if __name__ == '__main__':
    ...
    res = retriever.invoke("我最近压力好大，感觉什么都做不好，总是失眠。")
